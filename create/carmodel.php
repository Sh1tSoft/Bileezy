...
<?php if (isset($_GET['create'])) : ?>
    ...
    <form action="/includes/createcarmodel.php" method="POST">
        ...
        <label for="model_name">Model Navn</label>
        <input type="text" name="model_name">
        <label for="body_type">Karosseri Type</label>
        ...
        <label for="equipment_model">Udstyrs Model</label>
        <input type="text" name="equipment_model" placeholder="f.eks Titanium">
        <label for="engine_size">Motor Størrelse i Liter</label>
        <input type="text" name="engine_size" placeholder="f.eks 1,8">
        ...
        <input type="number" name="horsepower" placeholder="f.eks 170">
        <label for="torque">Moment N/m</label>
        <input type="number" name="torque" placeholder="f.eks 230">
        <label for="consumption">Forbrug (KM/L)</label>
        <input type="text" name="consumption" placeholder="f.eks 16,7">
        <label for="top_speed">Top Hastighed (KM/T)</label>
        <input type="text" name="top_speed" placeholder="f.eks 210">
        <label for="acceleration">Acceleration (0-100KM/T )</label>
        <input type="number" name="acceleration" placeholder="sekunder">
        <label for="transmission_type">Gearkasse</label>
        ...
        <label for="cylinders">Cylindere</label>
        ...
        <label for="drivetrain">Trækhjul</label>
        ...
        <label for="load_capacity">Lastevne</label>
        <input type="text" name="load_capacity">
        <label for="seats">Sæder</label>
        <select name="seats">
            <option value="1">1</option>
            <option value="2">2</option>
            <option value="3">3</option>
        ...
        <label for="fuel_type">Brændstof</label>
        ...
        <label for="tank_capacity">Tank Kapacitet</label>
        <input type="text" name="tank_capacity">
        <label for="year_start">Start År</label>
        <input type="text" name="year_start">
        <label for="year_end">Slut År</label>
